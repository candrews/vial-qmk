...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6_whole(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B,KC_HOME,         KC_MUTE,KC_N, KC_M, KC_COMM,KC_DOT ,KC_SLSH, KC_BSLASH,
        _______,_______,_______,KC_LBRC,KC_RBRC,RAISE,                 LOWER,KC_PLUS,KC_EQL,_______,_______,_______,
                                        KC_SPC, KC_HOME, KC_BSPC,   KC_DEL, KC_LALT, KC_ENT
        ),
    ...
    [_LOWER] = LAYOUT_5x6_whole(
        ...
        _______,_______,_______,SNIPING,DRGSCRL,KC_PSCR,                  _______,_______, KC_P0,_______,_______,_______,
                                       KC_BTN1,KC_BTN3,KC_BTN2,          QK_BOOT,_______,_______
        ),
